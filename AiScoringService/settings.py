...
GEMINI_ALIGNMENT_FALLBACK_MODELS = parse_env_list("GEMINI_ALIGNMENT_FALLBACK_MODELS")
GEMINI_ALIGNMENT_MODEL_CANDIDATES = unique_model_candidates(
    GEMINI_ALIGNMENT_MODEL,
    *GEMINI_ALIGNMENT_FALLBACK_MODELS,
)
LISTENING_ALIGNMENT_USE_GEMINI = parse_env_bool("LISTENING_ALIGNMENT_USE_GEMINI", False)
